...
function displayCardsDynamically(collection) {
  ...
  .limit(4) // limit cards to display
    ...
    .then((allHikes) => {
      ...
      allHikes.forEach((doc) => {
        ...
        // go to the user's document and check if the bookmarks array includes the hike's docID
        // if so, then dsiaply the filled bookmark icon
        currentUser.get().then((userDoc) => {
          //get the user name
